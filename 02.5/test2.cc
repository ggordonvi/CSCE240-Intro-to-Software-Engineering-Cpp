...
void TestToComplex() {
  ...
  if (complex_one.real() == 2.0 && complex_one.imag() == 2.0) {
    ...
    cout << "\tExpected: " << "(2 + 2i)" << "\tRecieved: " << complex_one.real() << endl;
    ++fails;
  }
  ...
  if (complex_two.real() == 2.5 && complex_two.imag() == 2.5) {
    ...
    cout << "\tExpected: " << "(2.5 + 2.5i)" << "\tRecieved: " << complex_two.real() << endl;
    ++fails;
  }
  ...
  if (complex_three.real() == 2.0 && complex_three.imag() == 0.0) {
    ...
    cout << "\tExpected: " << "(2)" << "\tRecieved: " << complex_three.real() << endl;
    ++fails;
  }
  ...
  if (complex_four.real() == 0.0 && complex_four.imag() == 2.0) {
    ...
    cout << "\tExpected: " << "(2i)" << "\tRecieved: " << complex_four.real() << endl;
    ++fails;
  }
  ...
  if (complex_five.real() == 2.0 && complex_five.imag() == -2.0) {
    ...
    cout << "\tExpected: " << "(2 - 2i)" << "\tRecieved: " << complex_five.real() << endl;
    ++fails;
  }
...
void TestOperator() {
  ...
  cout << "\n\tFirst test enter (2.2+3.3i)" << endl;
  cin >> test_complex;
  ...
  if(test_complex.real() == 2.2 && test_complex.imag() == 3.3) {
	  ++passes;
  } else {
